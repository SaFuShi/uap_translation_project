# プロベナンスチェック: ai_summary_024_dos_d1_papua_new_guinea_1985_note_version.md
...
| 項目 | 値 |
|---|---|
| ドラフト | `published_articles/ai_summary_024_dos_d1_papua_new_guinea_1985_note_version.md` |
| 元PDF | `dos-uap-d1-cable-1-papua-new-guinea-january-1985.pdf` |
| PDFページ数 | 3 |
| PDF文字数 | 2,899 |
| 抽出クレーム数 | 13 |
| OK | 13 |
...
|---|---|---|---|
| `Department of State` | paren_english | p.1 | `hn powers, acting-director us department of state 12/25/2026` |
| `NIO` | proper_noun | p.1 | `al intelligence organization (nio) concerning reported sight` |
| `PNG` | proper_noun | p.1 | `eceived informal inquiry from png national intelligence orga` |
| `B-52` | proper_noun | p.2 | `e have told nio we knew of no b-52 overflights and no u.s. a` |
| `MRN` | proper_noun | p.1 | `sified" 3/2/2026 unclassified mrn: 85 port moresby 199 date/` |
| `PORT MORESBY` | proper_noun | p.1 | `3/2/2026 unclassified mrn: 85 port moresby 199 date/dtg: jan` |
| `DTG` | proper_noun | p.1 | `mrn: 85 port moresby 199 date/dtg: jan 28, 1985 / 280000z ja` |
| `AMEMBASSY PORT MORESBY` | proper_noun | p.1 | `, 1985 / 280000z jan 85 from: amembassy port moresby action:` |
| `USCINCLANT` | proper_noun | p.1 | `membassy port moresby action: uscinclant routine e.0.: unkno` |
| `USCINCPAC` | proper_noun | p.1 | `fm amembassy port moresby to uscincpac honolulu hi immediate` |
| `LIMITED OFFICIAL USE` | proper_noun | p.1 | `guinea inquiry re overflights limited official use page 01 p` |
| `UNCLASSIFIED` | proper_noun | p.1 | `unclassified csp-2025-00040 b-00002707027` |
| `CSP-2025-00040` | proper_noun | p.1 | `unclassified csp-2025-00040 b-00002707027 "unclassified"` |
...
PAGE 01 
PORT M 00199 280704Z 
ACTION PM-11 
INFO OCT-00 COPY-01 ADS-00 INR-10 SS-00 
CIAE-00 DODE-00 
...
4. AL THOUGH INFORMATION PROVIDED US ON THESE SIGHTINGS 

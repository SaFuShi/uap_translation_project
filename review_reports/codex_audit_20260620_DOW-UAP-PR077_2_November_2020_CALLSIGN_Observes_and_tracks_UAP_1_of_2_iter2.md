...
IMG-1 PASS 視覚観察は「確認できる」「みられる」「可能性がある」「確認できない」等の留保付きで記述されている。
---ITEMS_END---
---WARN_DETAILS_START---

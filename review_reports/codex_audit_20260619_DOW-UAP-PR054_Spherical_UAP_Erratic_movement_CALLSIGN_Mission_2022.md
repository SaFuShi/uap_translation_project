...
P1-1 PASS ファイル名・Release Date・Incident Date・Related Location は files_catalog.csv と整合している
...
P2-1 WARN 記事タイトルが「#TBD」のままで、source_registry 未登録・article_id 未付番が本文末尾にも残っている
...
---ITEMS_END---
---WARN_DETAILS_START---
W-01: 文書メタデータ/末尾 | #TBD、source_registry 未登録、article_id の付番が未実施 | 登録後に article_id を反映し、未登録注意書きを公開前に削除する
W-02: 代表フレーム挿入行 | → 使用ファイル：...（note転記後にこの行を削除） | note公開本文に残さない作業用行として削除する

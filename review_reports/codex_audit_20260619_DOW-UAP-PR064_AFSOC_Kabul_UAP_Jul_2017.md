...
P2-3 WARN 「追尾継続が確認できる」は、UI表示継続から機器動作をやや強く読ませる表現になっている。
...
W-02: 要点3 | 00:10では映像が市街地俯瞰から別の構図へ変化し、追尾継続が確認できる | 「00:10では映像が市街地俯瞰から別の構図へ変化し、マゼンタ色のクロスヘア表示が継続して確認できる」のように、機器動作ではなく画面表示として記述する。
W-03: AI解析メモ | **AI解析メモ：** 動画ファイル。ffprobeによる技術情報取得済み。 | AI解析メモを出典後または免責直前など、テンプレートで定義した末尾位置へ移す。
---WARN_DETAILS_END---
---CODEX_AUDIT_END---